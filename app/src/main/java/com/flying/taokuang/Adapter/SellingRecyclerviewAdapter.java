...
public class SellingRecyclerviewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {


    private List<TaoKuang> mTaoList;
    private Context mContext;

    public SellingRecyclerviewAdapter(Context context) {
        mContext = context;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        return new SellingViewHolder(LayoutInflater.from(mContext)
                .inflate(R.layout.user_selling_item, viewGroup, false));
    }
