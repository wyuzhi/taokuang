...
public class PublishDialog extends Dialog {
    RelativeLayout mPublishMainRlmian;
    LinearLayout mPublishDialogFabu;
    LinearLayout mPublishDialogHuishou;
    LinearLayout mPublishDialogPinggu;
    LinearLayout mPublishDialogLlBt;
    ImageView mPublishDialogIvMenu;
